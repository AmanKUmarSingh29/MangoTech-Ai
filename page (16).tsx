import { db } from "@/db";
import { documents, quizAttempts, summaries, qaMessages } from "@/db/schema";
import { count, desc, sql, eq, or, isNull } from "drizzle-orm";
...
export default async function DashboardPage() {
  ...
  // Document count (user-specific + shared)
      ...
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-2">
          ...
          <h1 className="text-3xl font-bold">
            {session ? `Welcome back, ${session.name}!` : "Welcome to MangoTech AI"}
          </h1>
        </div>
